...
class BuildHyperModel(kt.HyperModel):
    ...
    def build(self, hp):
        ...
        filter_min = hp.Choice('filter_size_min', [512, 256])
        filter_max = hp.Choice('filter_size_max', [512])
        ...
        units_min = hp.Choice('units_min', [512, 1024])
        units_max = hp.Choice('units_max', [1024])
